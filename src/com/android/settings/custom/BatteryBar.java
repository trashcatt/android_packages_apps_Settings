...
public class BatteryBar extends SettingsPreferenceFragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mBatteryBarUseChargingColor.setChecked(Settings.System.getInt(resolver,
                    Settings.System.STATUSBAR_BATTERY_BAR_ENABLE_CHARGING_COLOR, 0) == 1);
            ...
            mBatteryBarBlendColors.setChecked(Settings.System.getInt(resolver,
                    Settings.System.STATUSBAR_BATTERY_BAR_BLEND_COLORS, 0) == 1);
            mBatteryBarBlendColors.setOnPreferenceChangeListener(this);
            
            mBatteryBarBlendColorsReverse = (SwitchPreference) findPreference(PREF_BATT_BLEND_COLORS_REVERSE);
			mBatteryBarBlendColorsReverse.setChecked(Settings.System.getInt(resolver,
                    Settings.System.STATUSBAR_BATTERY_BAR_BLEND_COLORS_REVERSE, 0) == 1);
			mBatteryBarBlendColorsReverse.setOnPreferenceChangeListener(this);
            ...
            boolean enableNavigationBar = Settings.Secure.getInt(resolver,
                    Settings.System.NAVIGATION_BAR_ENABLED, hasNavBarByDefault ? 1 : 0) == 1;
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mBatteryBarColor) {
                ...
                Settings.System.putInt(resolver,
                        Settings.System.STATUSBAR_BATTERY_BAR_ENABLE_CHARGING_COLOR, (boolean) newValue ? 1 : 0);
                return true;
            } else if (preference == mBatteryBarBlendColors) {
                Settings.System.putInt(resolver,
                        Settings.System.STATUSBAR_BATTERY_BAR_BLEND_COLORS, (boolean) newValue ? 1 : 0);
                return true;
            } else if (preference == mBatteryBarBlendColorsReverse) {
                Settings.System.putInt(resolver,
                        Settings.System.STATUSBAR_BATTERY_BAR_BLEND_COLORS_REVERSE, (boolean) newValue ? 1 : 0);
                return true;
            }
            return false;
        }
